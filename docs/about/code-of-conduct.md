...
### Behaviours that help build a positive community
...
This Code of Conduct applies to **all community spaces** and when
representing the community in public spaces (for example, using an
official email or social media account).

## Reporting Issues

If you experience or witness unacceptable behaviour, please report it
to the community leaders at <info@kartoza.com>.

We will review and investigate all complaints promptly and fairly. Your
...
- **Impact**: Serious or sustained inappropriate behaviour.
